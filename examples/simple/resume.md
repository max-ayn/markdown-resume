...
🔗 [example.com](https://example.com) | 📚 [Google Scholar](https://scholar.google.com/citations?user=example)
...
1. **Stone, A.**, Chen, L., & Manning, C. (2023). "Massively Multilingual Neural Machine Translation for 200+ Languages." *Transactions of the Association for Computational Linguistics*, 11, 847-863. [Impact Factor: 6.7]

2. **Stone, A.** & Barzilay, R. (2022). "Cross-Lingual Transfer Learning for Low-Resource Languages." *Journal of Artificial Intelligence Research*, 73, 1205-1240. [Impact Factor: 5.4]

3. Zhao, Y., **Stone, A.**, et al. (2021). "Zero-Shot Cross-Lingual Named Entity Recognition." *Computational Linguistics*, 47(3), 589-625. [Impact Factor: 7.2]

### Conference Papers (Peer-Reviewed)

4. **Stone, A.**, et al. (2024). "Efficient Few-Shot Learning for Multilingual Models." *Annual Meeting of the Association for Computational Linguistics (ACL)*. Bangkok, Thailand. [Acceptance Rate: 22%]

5. Lee, S. & **Stone, A.** (2023). "Adversarial Training for Robust NLP Models." *Conference on Empirical Methods in Natural Language Processing (EMNLP)*. Singapore. [Acceptance Rate: 24%]

6. **Stone, A.**, Martinez, A., & Chen, L. (2023). "Language-Agnostic Representation Learning." *International Conference on Learning Representations (ICLR)*. Kigali, Rwanda. [Acceptance Rate: 31%]

7. **Stone, A.** & Manning, C. (2022). "Unsupervised Cross-Lingual Alignment of Word Embeddings." *North American Chapter of the ACL (NAACL)*. Seattle, WA. [Acceptance Rate: 25%]

8. **Stone, A.**, et al. (2021). "Transfer Learning for Low-Resource Neural Machine Translation." *Annual Meeting of the ACL*. Virtual Conference. [**Best Paper Award**]

9. Chen, L., **Stone, A.**, & Manning, C. (2020). "Multilingual BERT for Cross-Lingual Understanding." *EMNLP*. Virtual Conference.

10. **Stone, A.** & Barzilay, R. (2019). "Semi-Supervised Learning for Neural NLP." *ACL*. Florence, Italy.
